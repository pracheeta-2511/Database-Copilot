...
![Query Results](Database-Copilot/screenshots/1.png)

![Home Pages](Database-Copilot/screenshots/2.png)

![Query History](Database-Copilot/screenshots/3.png)

![System Settings](Database-Copilot/screenshots/4.png)
